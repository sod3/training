        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-5">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground text-sm max-w-xs leading-relaxed">
              Find the trainer who gets you there. Meet verified personal trainers matched to your goals, schedule and location.
            </p>
          </div>
          
          <div>
            <h3 className="font-semibold mb-4 text-sm tracking-wider uppercase text-foreground">Marketplace</h3>
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li><Link href="/trainers" className="hover:text-primary transition-colors">Find Trainers</Link></li>
              <li><Link href="/trainers?gender=female" className="hover:text-primary transition-colors">Female Trainers</Link></li>
              <li><Link href="/trainers?type=online" className="hover:text-primary transition-colors">Online Trainers</Link></li>
              <li><Link href="/locations" className="hover:text-primary transition-colors">Locations</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="font-semibold mb-4 text-sm tracking-wider uppercase text-foreground">Company</h3>
            <ul className="space-y-3 text-sm text-muted-foreground">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-sm tracking-wider uppercase text-foreground">Support</h3>
            <ul className="space-y-3 text-sm text-muted-foreground">
